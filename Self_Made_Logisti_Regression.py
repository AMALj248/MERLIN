...
data = pd.read_csv('covid_19_data 28_May.csv')
...
x_train, x_test, y_train, y_test = train_test_split(x, y, test_size=0.33, random_state=5 ,shuffle= False)
...
mlp  = MLPRegressor(activation='relu',alpha=0.001 , batch_size='auto', beta_1=0.9,
